"use strict";(self.webpackChunkapp=self.webpackChunkapp||[]).push([["node_modules_ionic_core_dist_esm_ion-route_4_entry_js"],{4330:(A,b,p)=>{p.r(b),p.d(b,{ion_route:()=>D,ion_route_redirect:()=>L,ion_router:()=>tt,ion_router_link:()=>x});var f=p(5861),d=p(1308),R=p(5730),P=p(9658),C=p(2854);
/*!
