"use strict";(self.webpackChunkapp=self.webpackChunkapp||[]).push([["node_modules_ionic_core_dist_esm_ion-item_8_entry_js"],{4147:(S,f,a)=>{a.d(f,{a:()=>u,b:()=>i,p:()=>v});
/*!
     * (C) Ionic http://ionicframework.com - MIT License
     */
const v=(o,...m)=>console.warn(`[Ionic Warning]: ${o}`,...m),i=(o,...m)=>console.error(`[Ionic Error]: ${o}`,...m),u=(o,...m)=>console.error(`<${o.tagName.toLowerCase()}> must be used inside ${m.join(" or ")}.`)},4711:(S,f,a)=>{a.r(f),a.d(f,{ion_item:()=>s,ion_item_divider:()=>x,ion_item_group:()=>E,ion_label:()=>A,ion_list:()=>O,ion_list_header:()=>M,ion_note:()=>L,ion_skeleton_text:()=>D});var v=a(5861),i=a(1308),u=a(2357),o=a(9658),m=a(5730),y=a(4147),d=a(2854);
/*!
     * (C) Ionic http://ionicframework.com - MIT License
