"use strict";(self.webpackChunkapp=self.webpackChunkapp||[]).push([["node_modules_ionic_core_dist_esm_ion-accordion_2_entry_js"],{9654:(w,x,p)=>{p.r(x),p.d(x,{ion_accordion:()=>m,ion_accordion_group:()=>b});var l=p(5861),d=p(1308),v=p(2357),f=p(9658),h=p(5730);
/*!
