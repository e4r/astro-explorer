...
/*!
     ...
     */
const a=(s,...l)=>console.warn(`[Ionic Warning]: ${s}`,...l),n=(s,...l)=>console.error(`[Ionic Error]: ${s}`,...l),o=(s,...l)=>console.error(`<${s.tagName.toLowerCase()}> must be used inside ${l.join(" or ")}.`)},8034:(u,c,t)=>{t.r(c),t.d(c,{ion_infinite_scroll:()=>h,ion_infinite_scroll_content:()=>g});var a=t(5861),n=t(1308),o=t(9658),s=t(6642),l=t(8439);
/*!
     * (C) Ionic http://ionicframework.com - MIT License
